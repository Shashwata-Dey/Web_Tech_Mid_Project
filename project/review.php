...
<body>
    <header id="id3">
	    ...
	    <form>
			...
			<center>
			<center >
                <legend style="font-size:15px;color:#000000";><h1><b><u>CUSTOMER REVIEW</u></b></h1></legend>
		        <table style="border: 1px solid black;">
			        <tr>
                        <td  align="center" style="font-size:20px;"><span style="color:white;">Review:</span></td>
                        <td  align="center"><textarea name="complaint"></textarea></td>
                    </tr>
                    <tr>
					    <td  align="center">
